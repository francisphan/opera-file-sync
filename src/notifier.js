...
class Notifier {
    ...
    if (badEmails.length > 0) {
      htmlBody += `
        ...
        <table style="${tableStyle}">
          <thead>
          <tr>
            <th style="${thStyle};background:#ffebee">Name</th>
            <th style="${thStyle};background:#ffebee">Villa</th>
            <th style="${thStyle};background:#ffebee">PRS</th>
            <th style="${thStyle};background:#ffebee">Reason</th>
            <th style="${thStyle};background:#ffebee">Check-in</th>
            <th style="${thStyle};background:#ffebee">Check-out</th>
          </tr>
          </thead>
          ${badEmails.map(g => {
  ...
  /**
   * Send the daily front desk report (guests in house, arrivals, departures,
   * plus the email-collection priority list) with a CSV attachment.
   * @param {Object} reportData - From queryFrontDeskReport()
   */
